...
class CounterScreenWithoutProvider extends StatefulWidget {
  ...
  @override
  State<CounterScreenWithoutProvider> createState() =>
      _CounterScreenWithoutProviderState();
}

class _CounterScreenWithoutProviderState
    extends State<CounterScreenWithoutProvider> {
  int counter = 0;
